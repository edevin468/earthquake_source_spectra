...
def residual(params, freq, spec):
    ...
    stressdrop = params['stressdrop'].value
    U = params['U'].value
...
# define fixed Brune model parameters and add to params
beta = 3500. #3500m/s
...
params.add('stressdrop', value=5e6)
